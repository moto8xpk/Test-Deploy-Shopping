...
@Component({
  selector: 'app-junkfood-page',
  templateUrl: './junkfood-page.component.html',
  styleUrls: ['./junkfood-page.component.css']
})
export class JunkfoodPageComponent implements OnInit {
  ...
  ngOnInit() {
    this.productService.getProductsListByCategory(1)
    .subscribe(data => {
      this.products = data;
